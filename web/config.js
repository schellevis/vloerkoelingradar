...
export const CONFIG = {
  ...
  dewAxis: { min: 8, max: 22 }, // dauwpunt-schaal voor dag-ranges
  ...
  levels: [
    { upTo: 16, key: "volop", label: "Volop koelen", colorVar: "--c-green" },
    { upTo: 18, key: "gematigd", label: "Gematigd", colorVar: "--c-yellow" },
    { upTo: 21, key: "beperkt", label: "Beperkt", colorVar: "--c-orange" },
